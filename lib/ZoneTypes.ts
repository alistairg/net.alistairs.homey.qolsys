...
const ZONE_TYPE_MAP: Record<string, ZoneCapabilityMapping> = {
  ...
  [ZoneSensorType.GLASS_BREAK]:       { primaryCapability: 'alarm_glass_break', deviceClass: 'sensor' },
  [ZoneSensorType.PANEL_GLASS_BREAK]: { primaryCapability: 'alarm_glass_break', deviceClass: 'sensor' },
